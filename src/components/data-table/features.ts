...
export type DataTableColumn<T> = ColumnDef<DataTableFeatures, T, any>;
export type DataTableRow<T> = Row<DataTableFeatures, T>;
export type DataTableInstance<T> = Table<DataTableFeatures, T>;

/** Typed column builder: `const col = columnHelper<Member>()`. */
export const columnHelper = <T,>() => createColumnHelper<DataTableFeatures, T>();
