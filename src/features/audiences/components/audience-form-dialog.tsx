...
function AudienceFormDialogBody({
  ...
  const update = useAction(updateAudience, {
    ...
    <>
      <form onSubmit={submit} noValidate className="flex min-h-0 flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            An audience is a list of people you send emails to, like “Youth fellowship” or “Weekly
            newsletter”.
          </DialogDescription>
        </DialogHeader>
        <DialogBody className="grid gap-4">
          ...
          <Field
            ...
            htmlFor="aud-desc"
            optional
            hint="Helps other administrators know what this list is for."
          >
            <Textarea
              id="aud-desc"
              rows={2}
